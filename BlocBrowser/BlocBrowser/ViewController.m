...
- (void) updateButtonsAndTitle {
    ...
    self.reloadButton.enabled = !self.webView.isLoading && self.webView.URL; // since page can be clear after loading (restting), must also ensure a page has a URL if it can be reloaded
}
